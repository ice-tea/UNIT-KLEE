...
@.str1 = private unnamed_addr constant [4 x i8] c"len\00", align 1
...
entry:
  ...
  %0 = load i32* %n_addr, align 4, !dbg !126
  %1 = icmp sgt i32 %0, 5, !dbg !126
  br i1 %1, label %return, label %bb, !dbg !126

bb:                                               ; preds = %entry
  %2 = load i32* %n_addr, align 4, !dbg !128
  store i32 %2, i32* %i, align 4, !dbg !128
  br label %bb7, !dbg !128

bb1:                                              ; preds = %bb7
  store i32 1, i32* %j, align 4, !dbg !129
  br label %bb5, !dbg !129

bb2:                                              ; preds = %bb5
  %3 = load i32** %v_addr, align 8, !dbg !130
  %4 = load i32* %j, align 4, !dbg !130
  %5 = sext i32 %4 to i64, !dbg !130
  %6 = getelementptr inbounds i32* %3, i64 %5, !dbg !130
  %7 = load i32* %6, align 1, !dbg !130
  %8 = load i32* %j, align 4, !dbg !130
  %9 = add nsw i32 %8, 1, !dbg !130
  %10 = load i32** %v_addr, align 8, !dbg !130
  %11 = sext i32 %9 to i64, !dbg !130
  %12 = getelementptr inbounds i32* %10, i64 %11, !dbg !130
  %13 = load i32* %12, align 1, !dbg !130
  %14 = icmp sgt i32 %7, %13, !dbg !130
  br i1 %14, label %bb3, label %bb4, !dbg !130

bb3:                                              ; preds = %bb2
  %15 = load i32** %v_addr, align 8, !dbg !131
  %16 = load i32* %j, align 4, !dbg !131
  %17 = sext i32 %16 to i64, !dbg !131
  %18 = getelementptr inbounds i32* %15, i64 %17, !dbg !131
  %19 = load i32* %18, align 1, !dbg !131
  store i32 %19, i32* %k, align 4, !dbg !131
  %20 = load i32* %j, align 4, !dbg !132
  %21 = add nsw i32 %20, 1, !dbg !132
  %22 = load i32** %v_addr, align 8, !dbg !132
  %23 = sext i32 %21 to i64, !dbg !132
  %24 = getelementptr inbounds i32* %22, i64 %23, !dbg !132
  %25 = load i32* %24, align 1, !dbg !132
  %26 = load i32** %v_addr, align 8, !dbg !132
  %27 = load i32* %j, align 4, !dbg !132
  %28 = sext i32 %27 to i64, !dbg !132
  %29 = getelementptr inbounds i32* %26, i64 %28, !dbg !132
  store i32 %25, i32* %29, align 1, !dbg !132
  %30 = load i32* %j, align 4, !dbg !133
  %31 = add nsw i32 %30, 1, !dbg !133
  %32 = load i32** %v_addr, align 8, !dbg !133
  %33 = sext i32 %31 to i64, !dbg !133
  %34 = getelementptr inbounds i32* %32, i64 %33, !dbg !133
  %35 = load i32* %k, align 4, !dbg !133
  store i32 %35, i32* %34, align 1, !dbg !133
  br label %bb4, !dbg !133

bb4:                                              ; preds = %bb3, %bb2
  %36 = load i32* %j, align 4, !dbg !129
  %37 = add nsw i32 %36, 1, !dbg !129
  store i32 %37, i32* %j, align 4, !dbg !129
  br label %bb5, !dbg !129

bb5:                                              ; preds = %bb4, %bb1
  %38 = load i32* %j, align 4, !dbg !129
  %39 = load i32* %i, align 4, !dbg !129
  %40 = icmp slt i32 %38, %39, !dbg !129
  br i1 %40, label %bb2, label %bb6, !dbg !129

bb6:                                              ; preds = %bb5
  %41 = load i32* %i, align 4, !dbg !128
  %42 = sub nsw i32 %41, 1, !dbg !128
  store i32 %42, i32* %i, align 4, !dbg !128
  br label %bb7, !dbg !128

bb7:                                              ; preds = %bb6, %bb
  %43 = load i32* %i, align 4, !dbg !128
  %44 = icmp sgt i32 %43, 1, !dbg !128
  br i1 %44, label %bb1, label %return, !dbg !128
...
entry:
  ...
  %len = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %arr1 = bitcast [6 x i32]* %arr to i8*, !dbg !135
  call void @klee_make_symbolic(i8* %arr1, i64 24, i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !135
  %len2 = bitcast i32* %len to i8*, !dbg !137
  call void @klee_make_symbolic(i8* %len2, i64 4, i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !137
  %1 = load i32* %len, align 4, !dbg !138
  %arr3 = bitcast [6 x i32]* %arr to i32*, !dbg !138
  call void @bubble(i32* %arr3, i32 %1) nounwind, !dbg !138
  store i32 0, i32* %0, align 4, !dbg !139
  %2 = load i32* %0, align 4, !dbg !139
  store i32 %2, i32* %retval, align 4, !dbg !139
  %retval4 = load i32* %retval, !dbg !139
  ret i32 %retval4, !dbg !139
}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"bubble", metadata !"bubble", metadata !"bubble", metadata !1, i32 5, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32)* @bubble} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"bubble.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/examples/sort/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"bubble.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/examples/sort/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compil
...
!7 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 19, metadata !8, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!11 = metadata !{i32 589865, metadata !"klee_div_zero_check.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !12} ; [ DW_TAG_file_type ]
!12 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_div_zero_check.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} 
...
!17 = metadata !{i32 589865, metadata !"klee_int.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !18} ; [ DW_TAG_file_type ]
!18 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_int.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_
...
!26 = metadata !{i32 589865, metadata !"klee_overshift_check.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !27} ; [ DW_TAG_file_type ]
!27 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_overshift_check.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0}
...
!32 = metadata !{i32 589865, metadata !"klee_range.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !33} ; [ DW_TAG_file_type ]
!33 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_range.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TA
...
!41 = metadata !{i32 589865, metadata !"memcpy.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !42} ; [ DW_TAG_file_type ]
!42 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_co
...
!50 = metadata !{i32 589865, metadata !"memmove.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !51} ; [ DW_TAG_file_type ]
!51 = metadata !{i32 589841, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_c
...
!59 = metadata !{i32 589865, metadata !"mempcpy.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !60} ; [ DW_TAG_file_type ]
!60 = metadata !{i32 589841, i32 0, i32 1, metadata !"mempcpy.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_c
...
!68 = metadata !{i32 589865, metadata !"memset.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !69} ; [ DW_TAG_file_type ]
!69 = metadata !{i32 589841, i32 0, i32 1, metadata !"memset.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_co
...
!126 = metadata !{i32 7, i32 0, metadata !127, null}
...
!133 = metadata !{i32 15, i32 0, metadata !127, null}
!134 = metadata !{i32 8, i32 0, metadata !127, null}
!135 = metadata !{i32 23, i32 0, metadata !136, null}
!136 = metadata !{i32 589835, metadata !7, i32 19, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!137 = metadata !{i32 24, i32 0, metadata !136, null}
!138 = metadata !{i32 25, i32 0, metadata !136, null}
!139 = metadata !{i32 27, i32 0, metadata !136, null}
!140 = metadata !{i32 13, i32 0, metadata !141, null}
!141 = metadata !{i32 589835, metadata !10, i32 12, i32 0, metadata !11, i32 0} ; [ DW_TAG_lexical_block ]
!142 = metadata !{i32 14, i32 0, metadata !141, null}
!143 = metadata !{i32 15, i32 0, metadata !141, null}
!144 = metadata !{i32 15, i32 0, metadata !80, null}
!145 = metadata !{i32 16, i32 0, metadata !80, null}
!146 = metadata !{i32 21, i32 0, metadata !147, null}
!147 = metadata !{i32 589835, metadata !25, i32 20, i32 0, metadata !26, i32 0} ; [ DW_TAG_lexical_block ]
!148 = metadata !{i32 27, i32 0, metadata !147, null}
!149 = metadata !{i32 29, i32 0, metadata !147, null}
!150 = metadata !{i32 16, i32 0, metadata !87, null}
!151 = metadata !{i32 17, i32 0, metadata !87, null}
!152 = metadata !{i32 19, i32 0, metadata !87, null}
!153 = metadata !{i32 22, i32 0, metadata !87, null}
!154 = metadata !{i32 25, i32 0, metadata !87, null}
!155 = metadata !{i32 26, i32 0, metadata !87, null}
!156 = metadata !{i32 28, i32 0, metadata !87, null}
!157 = metadata !{i32 29, i32 0, metadata !87, null}
!158 = metadata !{i32 32, i32 0, metadata !87, null}
!159 = metadata !{i32 20, i32 0, metadata !87, null}
!160 = metadata !{i32 15, i32 0, metadata !112, null}
!161 = metadata !{i32 16, i32 0, metadata !112, null}
!162 = metadata !{i32 17, i32 0, metadata !112, null}
