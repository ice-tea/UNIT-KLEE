...
bb1:                                              ; preds = %bb4
  %3 = load i32** %v_addr, align 8, !dbg !129
  %4 = load i32* %j, align 4, !dbg !129
  %5 = sext i32 %4 to i64, !dbg !129
  %6 = getelementptr inbounds i32* %3, i64 %5, !dbg !129
  %7 = load i32* %6, align 1, !dbg !129
  %8 = load i32* %j, align 4, !dbg !129
  %9 = add nsw i32 %8, 1, !dbg !129
  %10 = load i32** %v_addr, align 8, !dbg !129
  %11 = sext i32 %9 to i64, !dbg !129
  %12 = getelementptr inbounds i32* %10, i64 %11, !dbg !129
  %13 = load i32* %12, align 1, !dbg !129
  %14 = icmp sgt i32 %7, %13, !dbg !129
  br i1 %14, label %bb2, label %bb3, !dbg !129

bb2:                                              ; preds = %bb1
  %15 = load i32** %v_addr, align 8, !dbg !130
  %16 = load i32* %j, align 4, !dbg !130
  %17 = sext i32 %16 to i64, !dbg !130
  %18 = getelementptr inbounds i32* %15, i64 %17, !dbg !130
  %19 = load i32* %18, align 1, !dbg !130
  store i32 %19, i32* %k, align 4, !dbg !130
  %20 = load i32* %j, align 4, !dbg !131
  %21 = add nsw i32 %20, 1, !dbg !131
  %22 = load i32** %v_addr, align 8, !dbg !131
  %23 = sext i32 %21 to i64, !dbg !131
  %24 = getelementptr inbounds i32* %22, i64 %23, !dbg !131
  %25 = load i32* %24, align 1, !dbg !131
  %26 = load i32** %v_addr, align 8, !dbg !131
  %27 = load i32* %j, align 4, !dbg !131
  %28 = sext i32 %27 to i64, !dbg !131
  %29 = getelementptr inbounds i32* %26, i64 %28, !dbg !131
  store i32 %25, i32* %29, align 1, !dbg !131
  %30 = load i32* %j, align 4, !dbg !132
  %31 = add nsw i32 %30, 1, !dbg !132
  %32 = load i32** %v_addr, align 8, !dbg !132
  %33 = sext i32 %31 to i64, !dbg !132
  %34 = getelementptr inbounds i32* %32, i64 %33, !dbg !132
  %35 = load i32* %k, align 4, !dbg !132
  store i32 %35, i32* %34, align 1, !dbg !132
  br label %bb3, !dbg !132

bb3:                                              ; preds = %bb2, %bb1
  %36 = load i32* %i, align 4, !dbg !128
  %37 = sub nsw i32 %36, 1, !dbg !128
  store i32 %37, i32* %i, align 4, !dbg !128
  br label %bb4, !dbg !128

bb4:                                              ; preds = %bb3, %bb
  %38 = load i32* %i, align 4, !dbg !128
  %39 = icmp sgt i32 %38, 1, !dbg !128
  br i1 %39, label %bb1, label %return, !dbg !128

return:                                           ; preds = %entry, %bb4
  ret void, !dbg !133
}
...
entry:
  ...
  %len = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %arr1 = bitcast [6 x i32]* %arr to i8*, !dbg !134
  call void @klee_make_symbolic(i8* %arr1, i64 24, i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !134
  %len2 = bitcast i32* %len to i8*, !dbg !136
  call void @klee_make_symbolic(i8* %len2, i64 4, i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !136
  %1 = load i32* %len, align 4, !dbg !137
  %arr3 = bitcast [6 x i32]* %arr to i32*, !dbg !137
  call void @bubble(i32* %arr3, i32 %1) nounwind, !dbg !137
  store i32 0, i32* %0, align 4, !dbg !138
  %2 = load i32* %0, align 4, !dbg !138
  store i32 %2, i32* %retval, align 4, !dbg !138
  %retval4 = load i32* %retval, !dbg !138
  ret i32 %retval4, !dbg !138
}
...
!7 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 18, metadata !8, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!133 = metadata !{i32 8, i32 0, metadata !127, null}
!134 = metadata !{i32 22, i32 0, metadata !135, null}
!135 = metadata !{i32 589835, metadata !7, i32 18, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!136 = metadata !{i32 23, i32 0, metadata !135, null}
!137 = metadata !{i32 24, i32 0, metadata !135, null}
!138 = metadata !{i32 26, i32 0, metadata !135, null}
!139 = metadata !{i32 13, i32 0, metadata !140, null}
!140 = metadata !{i32 589835, metadata !10, i32 12, i32 0, metadata !11, i32 0} ; [ DW_TAG_lexical_block ]
!141 = metadata !{i32 14, i32 0, metadata !140, null}
!142 = metadata !{i32 15, i32 0, metadata !140, null}
!143 = metadata !{i32 15, i32 0, metadata !80, null}
!144 = metadata !{i32 16, i32 0, metadata !80, null}
!145 = metadata !{i32 21, i32 0, metadata !146, null}
!146 = metadata !{i32 589835, metadata !25, i32 20, i32 0, metadata !26, i32 0} ; [ DW_TAG_lexical_block ]
!147 = metadata !{i32 27, i32 0, metadata !146, null}
!148 = metadata !{i32 29, i32 0, metadata !146, null}
!149 = metadata !{i32 16, i32 0, metadata !87, null}
!150 = metadata !{i32 17, i32 0, metadata !87, null}
!151 = metadata !{i32 19, i32 0, metadata !87, null}
!152 = metadata !{i32 22, i32 0, metadata !87, null}
!153 = metadata !{i32 25, i32 0, metadata !87, null}
!154 = metadata !{i32 26, i32 0, metadata !87, null}
!155 = metadata !{i32 28, i32 0, metadata !87, null}
!156 = metadata !{i32 29, i32 0, metadata !87, null}
!157 = metadata !{i32 32, i32 0, metadata !87, null}
!158 = metadata !{i32 20, i32 0, metadata !87, null}
!159 = metadata !{i32 15, i32 0, metadata !112, null}
!160 = metadata !{i32 16, i32 0, metadata !112, null}
!161 = metadata !{i32 17, i32 0, metadata !112, null}
