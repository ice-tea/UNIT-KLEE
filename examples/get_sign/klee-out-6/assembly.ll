...
bb1:                                              ; preds = %entry
  store i32 -1, i32* %0, align 4, !dbg !128
  br label %bb2, !dbg !128

bb2:                                              ; preds = %bb1, %bb
  %3 = load i32* %0, align 4, !dbg !127
  store i32 %3, i32* %retval, align 4, !dbg !127
  %retval3 = load i32* %retval, !dbg !127
  ret i32 %retval3, !dbg !127
}
...
entry:
  ...
  %a = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast i32* %a to i8*, !dbg !129
  call void @klee_make_symbolic(i8* %a1, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !129
  %1 = load i32* %a, align 4, !dbg !131
  %2 = call i32 @get_sign(i32 %1) nounwind, !dbg !131
  store i32 %2, i32* %0, align 4, !dbg !131
  %3 = load i32* %0, align 4, !dbg !131
  store i32 %3, i32* %retval, align 4, !dbg !131
  %retval2 = load i32* %retval, !dbg !131
  ret i32 %retval2, !dbg !131
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !132
  br i1 %0, label %bb, label %return, !dbg !132
...
entry:
  ...
  %x1 = bitcast i32* %x to i8*, !dbg !136
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* %name) nounwind, !dbg !136
  %0 = load i32* %x, align 4, !dbg !137
  ret i32 %0, !dbg !137
}

define void @klee_overshift_check(i64 %bitWidth, i64 %shift) nounwind {
entry:
  %0 = icmp ult i64 %shift, %bitWidth, !dbg !138
  br i1 %0, label %return, label %bb, !dbg !138
...
entry:
  %x = alloca i32, align 4
  %0 = icmp slt i32 %start, %end, !dbg !142
  br i1 %0, label %bb1, label %bb, !dbg !142

bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !143
  unreachable, !dbg !143

bb1:                                              ; preds = %entry
  %1 = add nsw i32 %start, 1, !dbg !144
  %2 = icmp eq i32 %1, %end, !dbg !144
  br i1 %2, label %bb8, label %bb3, !dbg !144

bb3:                                              ; preds = %bb1
  %x4 = bitcast i32* %x to i8*, !dbg !145
  call void @klee_make_symbolic(i8* %x4, i64 4, i8* %name) nounwind, !dbg !145
  %3 = icmp eq i32 %start, 0, !dbg !146
  %4 = load i32* %x, align 4, !dbg !147
  br i1 %3, label %bb5, label %bb6, !dbg !146

bb5:                                              ; preds = %bb3
  %5 = icmp ult i32 %4, %end, !dbg !147
  %6 = zext i1 %5 to i64, !dbg !147
  call void @klee_assume(i64 %6) nounwind, !dbg !147
  br label %bb7, !dbg !147

bb6:                                              ; preds = %bb3
  %7 = icmp sge i32 %4, %start, !dbg !148
  %8 = zext i1 %7 to i64, !dbg !148
  call void @klee_assume(i64 %8) nounwind, !dbg !148
  %9 = load i32* %x, align 4, !dbg !149
  %10 = icmp slt i32 %9, %end, !dbg !149
  %11 = zext i1 %10 to i64, !dbg !149
  call void @klee_assume(i64 %11) nounwind, !dbg !149
  br label %bb7, !dbg !149

bb7:                                              ; preds = %bb6, %bb5
  %12 = load i32* %x, align 4, !dbg !150
...
entry:
  %0 = icmp eq i64 %len, 0, !dbg !152
  br i1 %0, label %bb2, label %bb, !dbg !152
...
bb:                                               ; preds = %bb, %entry
  ...
  %1 = load i8* %src.06, align 1, !dbg !153
  store i8 %1, i8* %dest.05, align 1, !dbg !153
  %indvar.next = add i64 %indvar, 1
  %exitcond1 = icmp eq i64 %indvar.next, %len
  br i1 %exitcond1, label %bb1.bb2_crit_edge, label %bb, !dbg !152
...
!1 = metadata !{i32 589865, metadata !"get_sign.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/examples/get_sign/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"get_sign.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/examples/get_sign/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_
!3 = metadata !{i32 589845, metadata !1, metadata !"", metadata !1, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !4, i32 0, null} ; [ DW_TAG_subroutine_type ]
!4 = metadata !{metadata !5, metadata !5}
!5 = metadata !{i32 589860, metadata !1, metadata !"int", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!6 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 14, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!10 = metadata !{i32 589865, metadata !"klee_div_zero_check.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !11} ; [ DW_TAG_file_type ]
!11 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_div_zero_check.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} 
...
!16 = metadata !{i32 589865, metadata !"klee_int.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !17} ; [ DW_TAG_file_type ]
!17 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_int.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_
...
!25 = metadata !{i32 589865, metadata !"klee_overshift_check.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !26} ; [ DW_TAG_file_type ]
!26 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_overshift_check.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0}
...
!31 = metadata !{i32 589865, metadata !"klee_range.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !32} ; [ DW_TAG_file_type ]
!32 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_range.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TA
...
!40 = metadata !{i32 589865, metadata !"memcpy.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !41} ; [ DW_TAG_file_type ]
!41 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_co
...
!46 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/home/bo/Tools/llvm-gcc4.2-2.9-x86_64-linux/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include", metadata !41} ; [ DW_TAG_file_type ]
...
!49 = metadata !{i32 589865, metadata !"memmove.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !50} ; [ DW_TAG_file_type ]
!50 = metadata !{i32 589841, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_c
...
!55 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/home/bo/Tools/llvm-gcc4.2-2.9-x86_64-linux/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include", metadata !50} ; [ DW_TAG_file_type ]
...
!58 = metadata !{i32 589865, metadata !"mempcpy.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !59} ; [ DW_TAG_file_type ]
!59 = metadata !{i32 589841, i32 0, i32 1, metadata !"mempcpy.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_c
...
!64 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/home/bo/Tools/llvm-gcc4.2-2.9-x86_64-linux/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include", metadata !59} ; [ DW_TAG_file_type ]
...
!67 = metadata !{i32 589865, metadata !"memset.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !68} ; [ DW_TAG_file_type ]
!68 = metadata !{i32 589841, i32 0, i32 1, metadata !"memset.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_co
...
!74 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/home/bo/Tools/llvm-gcc4.2-2.9-x86_64-linux/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include", metadata !68} ; [ DW_TAG_file_type ]
...
!129 = metadata !{i32 16, i32 0, metadata !130, null}
!130 = metadata !{i32 589835, metadata !6, i32 14, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!131 = metadata !{i32 17, i32 0, metadata !130, null}
!132 = metadata !{i32 13, i32 0, metadata !133, null}
!133 = metadata !{i32 589835, metadata !9, i32 12, i32 0, metadata !10, i32 0} ; [ DW_TAG_lexical_block ]
!134 = metadata !{i32 14, i32 0, metadata !133, null}
!135 = metadata !{i32 15, i32 0, metadata !133, null}
!136 = metadata !{i32 15, i32 0, metadata !79, null}
!137 = metadata !{i32 16, i32 0, metadata !79, null}
!138 = metadata !{i32 21, i32 0, metadata !139, null}
!139 = metadata !{i32 589835, metadata !24, i32 20, i32 0, metadata !25, i32 0} ; [ DW_TAG_lexical_block ]
!140 = metadata !{i32 27, i32 0, metadata !139, null}
!141 = metadata !{i32 29, i32 0, metadata !139, null}
!142 = metadata !{i32 16, i32 0, metadata !86, null}
!143 = metadata !{i32 17, i32 0, metadata !86, null}
!144 = metadata !{i32 19, i32 0, metadata !86, null}
!145 = metadata !{i32 22, i32 0, metadata !86, null}
!146 = metadata !{i32 25, i32 0, metadata !86, null}
!147 = metadata !{i32 26, i32 0, metadata !86, null}
!148 = metadata !{i32 28, i32 0, metadata !86, null}
!149 = metadata !{i32 29, i32 0, metadata !86, null}
!150 = metadata !{i32 32, i32 0, metadata !86, null}
!151 = metadata !{i32 20, i32 0, metadata !86, null}
!152 = metadata !{i32 15, i32 0, metadata !111, null}
!153 = metadata !{i32 16, i32 0, metadata !111, null}
!154 = metadata !{i32 17, i32 0, metadata !111, null}
