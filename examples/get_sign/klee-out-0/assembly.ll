...
entry:
  ...
  store i32 1, i32* %y, align 4, !dbg !125
  br label %bb3, !dbg !125

bb:                                               ; preds = %bb3
  %1 = load i32* %y, align 4, !dbg !127
  %2 = mul nsw i32 %1, 2, !dbg !127
  store i32 %2, i32* %y, align 4, !dbg !127
  %3 = load i32* %y, align 4, !dbg !128
  %4 = icmp eq i32 %3, 8, !dbg !128
  br i1 %4, label %bb1, label %bb2, !dbg !128
...
bb2:                                              ; preds = %bb
  %5 = load i32* %x_addr, align 4, !dbg !130
  %6 = sub nsw i32 %5, 1, !dbg !130
  store i32 %6, i32* %x_addr, align 4, !dbg !130
  br label %bb3, !dbg !130

bb3:                                              ; preds = %bb2, %entry
  %7 = load i32* %x_addr, align 4, !dbg !131
  %8 = icmp sgt i32 %7, 0, !dbg !131
  br i1 %8, label %bb, label %bb4, !dbg !131
...
bb5:                                              ; preds = %bb4, %bb1
  %9 = load i32* %0, align 4, !dbg !129
  store i32 %9, i32* %retval, align 4, !dbg !129
  %retval6 = load i32* %retval, !dbg !129
  ret i32 %retval6, !dbg !129
}
...
entry:
  ...
  %a = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast i32* %a to i8*, !dbg !133
  call void @klee_make_symbolic(i8* %a1, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !133
  %1 = load i32* %a, align 4, !dbg !135
  %2 = call i32 @get_sign(i32 %1) nounwind, !dbg !135
  store i32 %2, i32* %0, align 4, !dbg !135
  %3 = load i32* %0, align 4, !dbg !135
  store i32 %3, i32* %retval, align 4, !dbg !135
  %retval2 = load i32* %retval, !dbg !135
  ret i32 %retval2, !dbg !135
}
...
!1 = metadata !{i32 589865, metadata !"deeploop.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/examples/get_sign/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"deeploop.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/examples/get_sign/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_
...
!127 = metadata !{i32 10, i32 0, metadata !126, null}
...
!131 = metadata !{i32 9, i32 0, metadata !126, null}
!132 = metadata !{i32 15, i32 0, metadata !126, null}
!133 = metadata !{i32 20, i32 0, metadata !134, null}
!134 = metadata !{i32 589835, metadata !6, i32 18, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!135 = metadata !{i32 21, i32 0, metadata !134, null}
!136 = metadata !{i32 13, i32 0, metadata !137, null}
!137 = metadata !{i32 589835, metadata !9, i32 12, i32 0, metadata !10, i32 0} ; [ DW_TAG_lexical_block ]
!138 = metadata !{i32 14, i32 0, metadata !137, null}
!139 = metadata !{i32 15, i32 0, metadata !137, null}
!140 = metadata !{i32 15, i32 0, metadata !79, null}
!141 = metadata !{i32 16, i32 0, metadata !79, null}
!142 = metadata !{i32 21, i32 0, metadata !143, null}
!143 = metadata !{i32 589835, metadata !24, i32 20, i32 0, metadata !25, i32 0} ; [ DW_TAG_lexical_block ]
!144 = metadata !{i32 27, i32 0, metadata !143, null}
!145 = metadata !{i32 29, i32 0, metadata !143, null}
!146 = metadata !{i32 16, i32 0, metadata !86, null}
!147 = metadata !{i32 17, i32 0, metadata !86, null}
!148 = metadata !{i32 19, i32 0, metadata !86, null}
!149 = metadata !{i32 22, i32 0, metadata !86, null}
!150 = metadata !{i32 25, i32 0, metadata !86, null}
!151 = metadata !{i32 26, i32 0, metadata !86, null}
!152 = metadata !{i32 28, i32 0, metadata !86, null}
!153 = metadata !{i32 29, i32 0, metadata !86, null}
!154 = metadata !{i32 32, i32 0, metadata !86, null}
!155 = metadata !{i32 20, i32 0, metadata !86, null}
!156 = metadata !{i32 15, i32 0, metadata !111, null}
!157 = metadata !{i32 16, i32 0, metadata !111, null}
!158 = metadata !{i32 17, i32 0, metadata !111, null}
