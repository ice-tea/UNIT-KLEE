...
define i32 @get_sign(i32 %x, i32 %y) nounwind {
entry:
  ...
  %2 = load i32* %y_addr, align 4, !dbg !125
  %3 = icmp slt i32 %1, %2, !dbg !125
...
bb1:                                              ; preds = %entry
  %4 = load i32* %x_addr, align 4, !dbg !128
  %5 = load i32* %y_addr, align 4, !dbg !128
...
!1 = metadata !{i32 589865, metadata !"diff.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/examples/get_sign/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"diff.c", metadata !"/home/bo/workspace/klee-g/UNIT-KLEE/examples/get_sign/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_comp
...
!134 = metadata !{i32 21, i32 0, metadata !132, null}
