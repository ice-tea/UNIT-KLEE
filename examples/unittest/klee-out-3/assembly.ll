...
entry:
  ...
  %b = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %1 = load i32* %a, align 4, !dbg !137
  %2 = load i32* %b, align 4, !dbg !137
  %3 = call i32 @fun2(i32 %1, i32 %2) nounwind, !dbg !137
  store i32 %3, i32* %0, align 4, !dbg !137
  %4 = load i32* %0, align 4, !dbg !137
  store i32 %4, i32* %retval, align 4, !dbg !137
...
!1 = metadata !{i32 589865, metadata !"test2.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/unittest/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"test2.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/unittest/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!137 = metadata !{i32 30, i32 0, metadata !138, null}
