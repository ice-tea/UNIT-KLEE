...
define i32 @get_sign(%struct.structA* %s) nounwind {
entry:
  %s_addr = alloca %struct.structA*, align 8
  %retval = alloca i32
  %0 = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  store %struct.structA* %s, %struct.structA** %s_addr
  %1 = load %struct.structA** %s_addr, align 8, !dbg !135
  %2 = getelementptr inbounds %struct.structA* %1, i32 0, i32 0, !dbg !135
  %3 = load i32* %2, align 4, !dbg !135
  %4 = load %struct.structA** %s_addr, align 8, !dbg !135
  %5 = getelementptr inbounds %struct.structA* %4, i32 0, i32 1, !dbg !135
  %6 = load i32* %5, align 4, !dbg !135
  %7 = icmp sgt i32 %3, %6, !dbg !135
  br i1 %7, label %bb, label %bb1, !dbg !135
...
bb1:                                              ; preds = %entry
  %8 = load %struct.structA** %s_addr, align 8, !dbg !138
  %9 = getelementptr inbounds %struct.structA* %8, i32 0, i32 0, !dbg !138
  %10 = load i32* %9, align 4, !dbg !138
  %11 = load %struct.structA** %s_addr, align 8, !dbg !138
  %12 = getelementptr inbounds %struct.structA* %11, i32 0, i32 1, !dbg !138
  %13 = load i32* %12, align 4, !dbg !138
  %14 = icmp slt i32 %10, %13, !dbg !138
...
define i32 @get_sign2(i64 %s.0) nounwind {
entry:
  %s_addr = alloca %struct.structA, align 4
  %retval = alloca i32
  %0 = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %1 = bitcast %struct.structA* %s_addr to %0*
  %2 = getelementptr inbounds %0* %1, i32 0, i32 0
  store i64 %s.0, i64* %2
  %3 = getelementptr inbounds %struct.structA* %s_addr, i32 0, i32 0, !dbg !141
  %4 = load i32* %3, align 4, !dbg !141
  %5 = getelementptr inbounds %struct.structA* %s_addr, i32 0, i32 1, !dbg !141
  %6 = load i32* %5, align 4, !dbg !141
  %7 = icmp sgt i32 %4, %6, !dbg !141
  br i1 %7, label %bb, label %bb1, !dbg !141
...
bb1:                                              ; preds = %entry
  %8 = getelementptr inbounds %struct.structA* %s_addr, i32 0, i32 0, !dbg !144
  %9 = load i32* %8, align 4, !dbg !144
  %10 = getelementptr inbounds %struct.structA* %s_addr, i32 0, i32 1, !dbg !144
  %11 = load i32* %10, align 4, !dbg !144
  %12 = icmp slt i32 %9, %11, !dbg !144
...
entry:
  %retval = alloca i32
  %0 = alloca i32
  %s = alloca [1 x %struct.structA]
  %"alloca point" = bitcast i32 0 to i32
  %s1 = bitcast [1 x %struct.structA]* %s to %struct.structA*, !dbg !147
  %s12 = bitcast %struct.structA* %s1 to i8*, !dbg !147
  call void @klee_make_symbolic(i8* %s12, i64 8, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !147
  %s3 = bitcast [1 x %struct.structA]* %s to %struct.structA*, !dbg !149
  %1 = call i32 @get_sign(%struct.structA* %s3) nounwind, !dbg !149
...
!llvm.dbg.sp = !{!0, !13, !16, !19, !25, !34, !40, !49, !58, !67, !76}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"get_sign", metadata !"get_sign", metadata !"get_sign", metadata !1, i32 14, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (%struct.structA*)* @get_sign} ; [ DW_TAG_su
!1 = metadata !{i32 589865, metadata !"struct2.c", metadata !"/home/bo/KleeWorkspace/klee/examples/mytest/point_struct/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"struct2.c", metadata !"/home/bo/KleeWorkspace/klee/examples/mytest/point_struct/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TA
...
!8 = metadata !{i32 589846, metadata !1, metadata !"structA", metadata !1, i32 11, i64 0, i64 0, i64 0, i32 0, metadata !9} ; [ DW_TAG_typedef ]
!9 = metadata !{i32 589843, metadata !1, metadata !"first", metadata !1, i32 8, i64 64, i64 32, i64 0, i32 0, null, metadata !10, i32 0, null} ; [ DW_TAG_structure_type ]
!10 = metadata !{metadata !11, metadata !12}
!11 = metadata !{i32 589837, metadata !9, metadata !"a", metadata !1, i32 9, i64 32, i64 32, i64 0, i32 0, metadata !5} ; [ DW_TAG_member ]
!12 = metadata !{i32 589837, metadata !9, metadata !"b", metadata !1, i32 10, i64 32, i64 32, i64 32, i32 0, metadata !5} ; [ DW_TAG_member ]
!13 = metadata !{i32 589870, i32 0, metadata !1, metadata !"get_sign2", metadata !"get_sign2", metadata !"get_sign2", metadata !1, i32 23, metadata !14, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i64)* @get_sign2} ; [ DW_TAG_subprogra
...
!15 = metadata !{metadata !5, metadata !8}
!16 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 33, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!20 = metadata !{i32 589865, metadata !"klee_div_zero_check.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !21} ; [ DW_TAG_file_type ]
!21 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_div_zero_check.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_T
...
!26 = metadata !{i32 589865, metadata !"klee_int.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !27} ; [ DW_TAG_file_type ]
!27 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_int.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_
...
!35 = metadata !{i32 589865, metadata !"klee_overshift_check.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !36} ; [ DW_TAG_file_type ]
!36 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_overshift_check.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_
...
!41 = metadata !{i32 589865, metadata !"klee_range.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !42} ; [ DW_TAG_file_type ]
!42 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_range.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compil
...
!50 = metadata !{i32 589865, metadata !"memcpy.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !51} ; [ DW_TAG_file_type ]
!51 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_un
...
!59 = metadata !{i32 589865, metadata !"memmove.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !60} ; [ DW_TAG_file_type ]
!60 = metadata !{i32 589841, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_u
...
!68 = metadata !{i32 589865, metadata !"mempcpy.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !69} ; [ DW_TAG_file_type ]
!69 = metadata !{i32 589841, i32 0, i32 1, metadata !"mempcpy.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_u
...
!77 = metadata !{i32 589865, metadata !"memset.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !78} ; [ DW_TAG_file_type ]
!78 = metadata !{i32 589841, i32 0, i32 1, metadata !"memset.c", metadata !"/home/bo/KleeWorkspace/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_un
...
!142 = metadata !{i32 589835, metadata !13, i32 23, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!143 = metadata !{i32 25, i32 0, metadata !142, null}
!144 = metadata !{i32 27, i32 0, metadata !142, null}
!145 = metadata !{i32 28, i32 0, metadata !142, null}
!146 = metadata !{i32 30, i32 0, metadata !142, null}
!147 = metadata !{i32 38, i32 0, metadata !148, null}
!148 = metadata !{i32 589835, metadata !16, i32 33, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!149 = metadata !{i32 39, i32 0, metadata !148, null}
!150 = metadata !{i32 13, i32 0, metadata !151, null}
!151 = metadata !{i32 589835, metadata !19, i32 12, i32 0, metadata !20, i32 0} ; [ DW_TAG_lexical_block ]
!152 = metadata !{i32 14, i32 0, metadata !151, null}
!153 = metadata !{i32 15, i32 0, metadata !151, null}
!154 = metadata !{i32 15, i32 0, metadata !89, null}
!155 = metadata !{i32 16, i32 0, metadata !89, null}
!156 = metadata !{i32 21, i32 0, metadata !157, null}
!157 = metadata !{i32 589835, metadata !34, i32 20, i32 0, metadata !35, i32 0} ; [ DW_TAG_lexical_block ]
!158 = metadata !{i32 27, i32 0, metadata !157, null}
!159 = metadata !{i32 29, i32 0, metadata !157, null}
!160 = metadata !{i32 16, i32 0, metadata !96, null}
!161 = metadata !{i32 17, i32 0, metadata !96, null}
!162 = metadata !{i32 19, i32 0, metadata !96, null}
!163 = metadata !{i32 22, i32 0, metadata !96, null}
!164 = metadata !{i32 25, i32 0, metadata !96, null}
!165 = metadata !{i32 26, i32 0, metadata !96, null}
!166 = metadata !{i32 28, i32 0, metadata !96, null}
!167 = metadata !{i32 29, i32 0, metadata !96, null}
!168 = metadata !{i32 32, i32 0, metadata !96, null}
!169 = metadata !{i32 20, i32 0, metadata !96, null}
!170 = metadata !{i32 15, i32 0, metadata !121, null}
!171 = metadata !{i32 16, i32 0, metadata !121, null}
!172 = metadata !{i32 17, i32 0, metadata !121, null}
