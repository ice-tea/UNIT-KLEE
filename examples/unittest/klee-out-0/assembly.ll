...
entry:
  ...
  %2 = load i32* %y_addr, align 4, !dbg !132
  %3 = call i32 @fun1(i32 %1, i32 %2) nounwind, !dbg !132
  store i32 %3, i32* %0, align 4, !dbg !132
  %4 = load i32* %0, align 4, !dbg !132
  store i32 %4, i32* %retval, align 4, !dbg !132
  %retval1 = load i32* %retval, !dbg !132
  ret i32 %retval1, !dbg !132
}
...
entry:
  ...
  %b = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast i32* %a to i8*, !dbg !134
  call void @klee_make_symbolic(i8* %a1, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !134
  %b2 = bitcast i32* %b to i8*, !dbg !136
  call void @klee_make_symbolic(i8* %b2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !136
  %1 = load i32* %b, align 4, !dbg !137
  %2 = load i32* %a, align 4, !dbg !137
  %3 = call i32 @fun2(i32 %2, i32 %1) nounwind, !dbg !137
...
!7 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 21, metadata !8, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!135 = metadata !{i32 589835, metadata !7, i32 21, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
