...
entry:
  ...
  %2 = icmp sgt i32 %1, 10, !dbg !125
  %3 = load i32* %x_addr, align 4, !dbg !127
  %4 = load i32* %y_addr, align 4, !dbg !127
  %5 = add nsw i32 %3, %4, !dbg !127
  br i1 %2, label %bb, label %bb1, !dbg !125

bb:                                               ; preds = %entry
  store i32 %5, i32* %x_addr, align 4, !dbg !127
  br label %bb2, !dbg !127

bb1:                                              ; preds = %entry
  store i32 %5, i32* %y_addr, align 4, !dbg !128
  br label %bb2, !dbg !128

bb2:                                              ; preds = %bb1, %bb
  store i32 0, i32* %0, align 4, !dbg !129
  %6 = load i32* %0, align 4, !dbg !129
  store i32 %6, i32* %retval, align 4, !dbg !129
...
entry:
  ...
  %b = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast i32* %a to i8*, !dbg !130
  call void @klee_make_symbolic(i8* %a1, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !130
  %b2 = bitcast i32* %b to i8*, !dbg !132
  call void @klee_make_symbolic(i8* %b2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !132
  %1 = load i32* %b, align 4, !dbg !133
  %2 = load i32* %a, align 4, !dbg !133
  %3 = call i32 @fun2(i32 %2, i32 %1) nounwind, !dbg !133
  store i32 %3, i32* %0, align 4, !dbg !133
  %4 = load i32* %0, align 4, !dbg !133
  store i32 %4, i32* %retval, align 4, !dbg !133
  %retval3 = load i32* %retval, !dbg !133
  ret i32 %retval3, !dbg !133
}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"fun2", metadata !"fun2", metadata !"fun2", metadata !1, i32 7, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i32)* @fun2} ; [ DW_TAG_subprogram ]
...
!6 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 15, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!131 = metadata !{i32 589835, metadata !6, i32 15, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!132 = metadata !{i32 19, i32 0, metadata !131, null}
!133 = metadata !{i32 20, i32 0, metadata !131, null}
