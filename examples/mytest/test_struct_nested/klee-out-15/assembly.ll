...
bb3:                                              ; preds = %bb1
  %15 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 2, !dbg !140
  %16 = getelementptr inbounds %struct.anon* %15, i32 0, i32 0, !dbg !140
  %17 = load i32* %16, align 4, !dbg !140
  %18 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 2, !dbg !140
  %19 = getelementptr inbounds %struct.anon* %18, i32 0, i32 1, !dbg !140
  %20 = load i32* %19, align 4, !dbg !140
  %21 = icmp slt i32 %17, %20, !dbg !140
  br i1 %21, label %bb4, label %bb5, !dbg !140

bb4:                                              ; preds = %bb3
  store i32 1, i32* %0, align 4, !dbg !141
  br label %bb6, !dbg !141

bb5:                                              ; preds = %bb3
  store i32 2, i32* %0, align 4, !dbg !142
  br label %bb6, !dbg !142

bb6:                                              ; preds = %bb5, %bb4, %bb2, %bb
  %22 = load i32* %0, align 4, !dbg !137
  store i32 %22, i32* %retval, align 4, !dbg !137
  %retval7 = load i32* %retval, !dbg !137
  ret i32 %retval7, !dbg !137
}
...
entry:
  ...
  %"alloca point" = bitcast i32 0 to i32
  %mystruct1 = bitcast %struct.f* %mystruct to i8*, !dbg !143
  call void @klee_make_symbolic(i8* %mystruct1, i64 16, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !143
  %1 = bitcast %struct.f* %mystruct to %0*, !dbg !145
  %elt = getelementptr inbounds %0* %1, i32 0, i32 0, !dbg !145
  %val = load i64* %elt, !dbg !145
  %2 = bitcast %struct.f* %mystruct to %0*, !dbg !145
  %elt2 = getelementptr inbounds %0* %2, i32 0, i32 1, !dbg !145
  %val3 = load i64* %elt2, !dbg !145
  %3 = call i32 @get_sign(i64 %val, i64 %val3) nounwind, !dbg !145
  store i32 %3, i32* %0, align 4, !dbg !145
  %4 = load i32* %0, align 4, !dbg !145
  store i32 %4, i32* %retval, align 4, !dbg !145
  %retval4 = load i32* %retval, !dbg !145
  ret i32 %retval4, !dbg !145
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !146
  br i1 %0, label %bb, label %return, !dbg !146
...
entry:
  ...
  %x1 = bitcast i32* %x to i8*, !dbg !150
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* %name) nounwind, !dbg !150
  %0 = load i32* %x, align 4, !dbg !151
  ret i32 %0, !dbg !151
}

define void @klee_overshift_check(i64 %bitWidth, i64 %shift) nounwind {
entry:
  %0 = icmp ult i64 %shift, %bitWidth, !dbg !152
  br i1 %0, label %return, label %bb, !dbg !152
...
entry:
  %x = alloca i32, align 4
  %0 = icmp slt i32 %start, %end, !dbg !156
  br i1 %0, label %bb1, label %bb, !dbg !156

bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !157
  unreachable, !dbg !157

bb1:                                              ; preds = %entry
  %1 = add nsw i32 %start, 1, !dbg !158
  %2 = icmp eq i32 %1, %end, !dbg !158
  br i1 %2, label %bb8, label %bb3, !dbg !158

bb3:                                              ; preds = %bb1
  %x4 = bitcast i32* %x to i8*, !dbg !159
  call void @klee_make_symbolic(i8* %x4, i64 4, i8* %name) nounwind, !dbg !159
  %3 = icmp eq i32 %start, 0, !dbg !160
  %4 = load i32* %x, align 4, !dbg !161
  br i1 %3, label %bb5, label %bb6, !dbg !160

bb5:                                              ; preds = %bb3
  %5 = icmp ult i32 %4, %end, !dbg !161
  %6 = zext i1 %5 to i64, !dbg !161
  call void @klee_assume(i64 %6) nounwind, !dbg !161
  br label %bb7, !dbg !161

bb6:                                              ; preds = %bb3
  %7 = icmp sge i32 %4, %start, !dbg !162
  %8 = zext i1 %7 to i64, !dbg !162
  call void @klee_assume(i64 %8) nounwind, !dbg !162
  %9 = load i32* %x, align 4, !dbg !163
  %10 = icmp slt i32 %9, %end, !dbg !163
  %11 = zext i1 %10 to i64, !dbg !163
  call void @klee_assume(i64 %11) nounwind, !dbg !163
  br label %bb7, !dbg !163

bb7:                                              ; preds = %bb6, %bb5
  %12 = load i32* %x, align 4, !dbg !164
  br label %bb8, !dbg !164
...
entry:
  %0 = icmp eq i64 %len, 0, !dbg !166
  br i1 %0, label %bb2, label %bb, !dbg !166
...
bb:                                               ; preds = %bb, %entry
  ...
  %1 = load i8* %src.06, align 1, !dbg !167
  store i8 %1, i8* %dest.05, align 1, !dbg !167
  %indvar.next = add i64 %indvar, 1
  %exitcond1 = icmp eq i64 %indvar.next, %len
  br i1 %exitcond1, label %bb1.bb2_crit_edge, label %bb, !dbg !166
...
!16 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 26, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!140 = metadata !{i32 20, i32 0, metadata !136, null}
!141 = metadata !{i32 21, i32 0, metadata !136, null}
!142 = metadata !{i32 23, i32 0, metadata !136, null}
!143 = metadata !{i32 28, i32 0, metadata !144, null}
!144 = metadata !{i32 589835, metadata !16, i32 26, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!145 = metadata !{i32 33, i32 0, metadata !144, null}
!146 = metadata !{i32 13, i32 0, metadata !147, null}
!147 = metadata !{i32 589835, metadata !19, i32 12, i32 0, metadata !20, i32 0} ; [ DW_TAG_lexical_block ]
!148 = metadata !{i32 14, i32 0, metadata !147, null}
!149 = metadata !{i32 15, i32 0, metadata !147, null}
!150 = metadata !{i32 15, i32 0, metadata !89, null}
!151 = metadata !{i32 16, i32 0, metadata !89, null}
!152 = metadata !{i32 21, i32 0, metadata !153, null}
!153 = metadata !{i32 589835, metadata !34, i32 20, i32 0, metadata !35, i32 0} ; [ DW_TAG_lexical_block ]
!154 = metadata !{i32 27, i32 0, metadata !153, null}
!155 = metadata !{i32 29, i32 0, metadata !153, null}
!156 = metadata !{i32 16, i32 0, metadata !96, null}
!157 = metadata !{i32 17, i32 0, metadata !96, null}
!158 = metadata !{i32 19, i32 0, metadata !96, null}
!159 = metadata !{i32 22, i32 0, metadata !96, null}
!160 = metadata !{i32 25, i32 0, metadata !96, null}
!161 = metadata !{i32 26, i32 0, metadata !96, null}
!162 = metadata !{i32 28, i32 0, metadata !96, null}
!163 = metadata !{i32 29, i32 0, metadata !96, null}
!164 = metadata !{i32 32, i32 0, metadata !96, null}
!165 = metadata !{i32 20, i32 0, metadata !96, null}
!166 = metadata !{i32 15, i32 0, metadata !121, null}
!167 = metadata !{i32 16, i32 0, metadata !121, null}
!168 = metadata !{i32 17, i32 0, metadata !121, null}
