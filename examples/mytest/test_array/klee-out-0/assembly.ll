...
entry:
  ...
  br i1 %7, label %bb, label %bb1, !dbg !126
...
bb1:                                              ; preds = %entry
  %8 = load i32** %arr_addr, align 8, !dbg !129
  %9 = getelementptr inbounds i32* %8, i64 0, !dbg !129
  %10 = load i32* %9, align 1, !dbg !129
  %11 = load i32** %arr_addr, align 8, !dbg !129
  %12 = getelementptr inbounds i32* %11, i64 1, !dbg !129
  %13 = load i32* %12, align 1, !dbg !129
  %14 = icmp slt i32 %10, %13, !dbg !129
...
bb4:                                              ; preds = %bb3, %bb2, %bb
  %15 = load i32* %0, align 4, !dbg !128
  store i32 %15, i32* %retval, align 4, !dbg !128
...
entry:
  ...
  %a = alloca [2 x i32]
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast [2 x i32]* %a to i8*, !dbg !132
  call void @klee_make_symbolic(i8* %a1, i64 8, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !132
  %a2 = bitcast [2 x i32]* %a to i32*, !dbg !134
  %1 = call i32 @get_sign(i32* %a2) nounwind, !dbg !134
  store i32 %1, i32* %0, align 4, !dbg !134
  %2 = load i32* %0, align 4, !dbg !134
...
!134 = metadata !{i32 20, i32 0, metadata !133, null}
