...
define i32 @get_sign(i32 %a, i32 %b) nounwind {
entry:
  ...
  %1 = load i32* %a_addr, align 4, !dbg !125
  %2 = load i32* %b_addr, align 4, !dbg !125
  %3 = icmp sgt i32 %1, %2, !dbg !125
  br i1 %3, label %bb, label %bb1, !dbg !125
...
bb1:                                              ; preds = %entry
  %4 = load i32* %a_addr, align 4, !dbg !128
  %5 = load i32* %b_addr, align 4, !dbg !128
  %6 = icmp eq i32 %4, %5, !dbg !128
  br i1 %6, label %bb2, label %bb3, !dbg !128
...
bb4:                                              ; preds = %bb3, %bb2, %bb
  %7 = load i32* %0, align 4, !dbg !127
  store i32 %7, i32* %retval, align 4, !dbg !127
...
entry:
  ...
  %b2 = bitcast i32* %b to i8*, !dbg !133
  call void @klee_make_symbolic(i8* %b2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !133
  %1 = load i32* %b, align 4, !dbg !134
  %2 = load i32* %a, align 4, !dbg !134
  %3 = call i32 @get_sign(i32 %2, i32 %1) nounwind, !dbg !134
  store i32 %3, i32* %0, align 4, !dbg !134
  %4 = load i32* %0, align 4, !dbg !134
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"get_sign", metadata !"get_sign", metadata !"get_sign", metadata !1, i32 7, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i32)* @get_sign} ; [ DW_TAG_subprogram 
!1 = metadata !{i32 589865, metadata !"two_input.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_simple/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"two_input.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_simple/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} 
...
!10 = metadata !{i32 589865, metadata !"klee_div_zero_check.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !11} ; [ DW_TAG_file_type ]
!11 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_div_zero_check.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} 
...
!16 = metadata !{i32 589865, metadata !"klee_int.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !17} ; [ DW_TAG_file_type ]
!17 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_int.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_
...
!25 = metadata !{i32 589865, metadata !"klee_overshift_check.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !26} ; [ DW_TAG_file_type ]
!26 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_overshift_check.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0}
...
!31 = metadata !{i32 589865, metadata !"klee_range.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !32} ; [ DW_TAG_file_type ]
!32 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_range.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TA
...
!40 = metadata !{i32 589865, metadata !"memcpy.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !41} ; [ DW_TAG_file_type ]
!41 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_co
...
!49 = metadata !{i32 589865, metadata !"memmove.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !50} ; [ DW_TAG_file_type ]
!50 = metadata !{i32 589841, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_c
...
!58 = metadata !{i32 589865, metadata !"mempcpy.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !59} ; [ DW_TAG_file_type ]
!59 = metadata !{i32 589841, i32 0, i32 1, metadata !"mempcpy.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_c
...
!67 = metadata !{i32 589865, metadata !"memset.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !68} ; [ DW_TAG_file_type ]
!68 = metadata !{i32 589841, i32 0, i32 1, metadata !"memset.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_co
...
!128 = metadata !{i32 10, i32 0, metadata !126, null}
!129 = metadata !{i32 11, i32 0, metadata !126, null}
!130 = metadata !{i32 13, i32 0, metadata !126, null}
!131 = metadata !{i32 18, i32 0, metadata !132, null}
!132 = metadata !{i32 589835, metadata !6, i32 16, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!133 = metadata !{i32 19, i32 0, metadata !132, null}
!134 = metadata !{i32 20, i32 0, metadata !132, null}
!135 = metadata !{i32 13, i32 0, metadata !136, null}
!136 = metadata !{i32 589835, metadata !9, i32 12, i32 0, metadata !10, i32 0} ; [ DW_TAG_lexical_block ]
!137 = metadata !{i32 14, i32 0, metadata !136, null}
!138 = metadata !{i32 15, i32 0, metadata !136, null}
!139 = metadata !{i32 15, i32 0, metadata !79, null}
!140 = metadata !{i32 16, i32 0, metadata !79, null}
!141 = metadata !{i32 21, i32 0, metadata !142, null}
!142 = metadata !{i32 589835, metadata !24, i32 20, i32 0, metadata !25, i32 0} ; [ DW_TAG_lexical_block ]
!143 = metadata !{i32 27, i32 0, metadata !142, null}
!144 = metadata !{i32 29, i32 0, metadata !142, null}
!145 = metadata !{i32 16, i32 0, metadata !86, null}
!146 = metadata !{i32 17, i32 0, metadata !86, null}
!147 = metadata !{i32 19, i32 0, metadata !86, null}
!148 = metadata !{i32 22, i32 0, metadata !86, null}
!149 = metadata !{i32 25, i32 0, metadata !86, null}
!150 = metadata !{i32 26, i32 0, metadata !86, null}
!151 = metadata !{i32 28, i32 0, metadata !86, null}
!152 = metadata !{i32 29, i32 0, metadata !86, null}
!153 = metadata !{i32 32, i32 0, metadata !86, null}
!154 = metadata !{i32 20, i32 0, metadata !86, null}
!155 = metadata !{i32 15, i32 0, metadata !111, null}
!156 = metadata !{i32 16, i32 0, metadata !111, null}
!157 = metadata !{i32 17, i32 0, metadata !111, null}
