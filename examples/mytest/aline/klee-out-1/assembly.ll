...
entry:
  ...
  store i64 %s.0, i64* %2
  %3 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 0, !dbg !131
  %4 = load i8* %3, align 4, !dbg !131
  %5 = sext i8 %4 to i32, !dbg !131
  %6 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 1, !dbg !131
  %7 = load i32* %6, align 4, !dbg !131
  %8 = icmp sgt i32 %5, %7, !dbg !131
  br i1 %8, label %bb, label %bb1, !dbg !131
...
bb1:                                              ; preds = %entry
  %9 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 0, !dbg !134
  %10 = load i8* %9, align 4, !dbg !134
  %11 = sext i8 %10 to i32, !dbg !134
  %12 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 1, !dbg !134
  %13 = load i32* %12, align 4, !dbg !134
  %14 = icmp slt i32 %11, %13, !dbg !134
  br i1 %14, label %bb2, label %bb3, !dbg !134
...
bb4:                                              ; preds = %bb3, %bb2, %bb
  %15 = load i32* %0, align 4, !dbg !133
  store i32 %15, i32* %retval, align 4, !dbg !133
...
entry:
  ...
  call void @klee_make_symbolic(i8* %mystruct1, i64 8, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !137
  %1 = bitcast %struct.f* %mystruct to %0*, !dbg !139
  %elt = getelementptr inbounds %0* %1, i32 0, i32 0, !dbg !139
  %val = load i64* %elt, !dbg !139
  %2 = call i32 @get_sign(i64 %val) nounwind, !dbg !139
  store i32 %2, i32* %0, align 4, !dbg !139
  %3 = load i32* %0, align 4, !dbg !139
  store i32 %3, i32* %retval, align 4, !dbg !139
  %retval2 = load i32* %retval, !dbg !139
  ret i32 %retval2, !dbg !139
}
...
!1 = metadata !{i32 589865, metadata !"struct.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/aline/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"struct.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/aline/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TA
...
!9 = metadata !{i32 589837, metadata !7, metadata !"a", metadata !1, i32 9, i64 8, i64 8, i64 0, i32 0, metadata !10} ; [ DW_TAG_member ]
!10 = metadata !{i32 589860, metadata !1, metadata !"char", metadata !1, i32 0, i64 8, i64 8, i64 0, i32 0, i32 6} ; [ DW_TAG_base_type ]
!11 = metadata !{i32 589837, metadata !7, metadata !"b", metadata !1, i32 10, i64 32, i64 32, i64 32, i32 0, metadata !5} ; [ DW_TAG_member ]
!12 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 23, metadata !13, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!131 = metadata !{i32 14, i32 0, metadata !132, null}
!132 = metadata !{i32 589835, metadata !0, i32 13, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!133 = metadata !{i32 15, i32 0, metadata !132, null}
!134 = metadata !{i32 17, i32 0, metadata !132, null}
!135 = metadata !{i32 18, i32 0, metadata !132, null}
!136 = metadata !{i32 20, i32 0, metadata !132, null}
!137 = metadata !{i32 25, i32 0, metadata !138, null}
!138 = metadata !{i32 589835, metadata !12, i32 23, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!139 = metadata !{i32 30, i32 0, metadata !138, null}
