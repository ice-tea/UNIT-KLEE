...
define i32 @get_sign(i64 %s.0) nounwind {
entry:
  ...
  store i64 %s.0, i64* %2
  %3 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 0, !dbg !130
  %4 = load i32* %3, align 4, !dbg !130
  %5 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 1, !dbg !130
  %6 = load i32* %5, align 4, !dbg !130
  %7 = icmp sgt i32 %4, %6, !dbg !130
  br i1 %7, label %bb, label %bb1, !dbg !130
...
bb1:                                              ; preds = %entry
  %8 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 0, !dbg !133
  %9 = load i32* %8, align 4, !dbg !133
  %10 = getelementptr inbounds %struct.f* %s_addr, i32 0, i32 1, !dbg !133
  %11 = load i32* %10, align 4, !dbg !133
  %12 = icmp slt i32 %9, %11, !dbg !133
  br i1 %12, label %bb2, label %bb3, !dbg !133
...
bb4:                                              ; preds = %bb3, %bb2, %bb
  %13 = load i32* %0, align 4, !dbg !132
  store i32 %13, i32* %retval, align 4, !dbg !132
...
entry:
  ...
  %"alloca point" = bitcast i32 0 to i32
  %mystruct1 = bitcast %struct.f* %mystruct to i8*, !dbg !136
  call void @klee_make_symbolic(i8* %mystruct1, i64 8, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !136
  %1 = bitcast %struct.f* %mystruct to %0*, !dbg !138
  %elt = getelementptr inbounds %0* %1, i32 0, i32 0, !dbg !138
  %val = load i64* %elt, !dbg !138
  %2 = call i32 @get_sign(i64 %val) nounwind, !dbg !138
  store i32 %2, i32* %0, align 4, !dbg !138
  %3 = load i32* %0, align 4, !dbg !138
  store i32 %3, i32* %retval, align 4, !dbg !138
  %retval2 = load i32* %retval, !dbg !138
  ret i32 %retval2, !dbg !138
}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"get_sign", metadata !"get_sign", metadata !"get_sign", metadata !1, i32 13, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i64)* @get_sign} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"struct.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_struct2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"struct.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_struct2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; 
!3 = metadata !{i32 589845, metadata !1, metadata !"", metadata !1, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !4, i32 0, null} ; [ DW_TAG_subroutine_type ]
!4 = metadata !{metadata !5, metadata !6}
!5 = metadata !{i32 589860, metadata !1, metadata !"int", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!6 = metadata !{i32 589846, metadata !1, metadata !"f", metadata !1, i32 11, i64 0, i64 0, i64 0, i32 0, metadata !7} ; [ DW_TAG_typedef ]
!7 = metadata !{i32 589843, metadata !1, metadata !"first", metadata !1, i32 8, i64 64, i64 32, i64 0, i32 0, null, metadata !8, i32 0, null} ; [ DW_TAG_structure_type ]
...
!15 = metadata !{i32 589865, metadata !"klee_div_zero_check.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !16} ; [ DW_TAG_file_type ]
!16 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_div_zero_check.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} 
...
!21 = metadata !{i32 589865, metadata !"klee_int.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !22} ; [ DW_TAG_file_type ]
!22 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_int.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_
...
!30 = metadata !{i32 589865, metadata !"klee_overshift_check.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !31} ; [ DW_TAG_file_type ]
!31 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_overshift_check.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0}
...
!36 = metadata !{i32 589865, metadata !"klee_range.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !37} ; [ DW_TAG_file_type ]
!37 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_range.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TA
...
!45 = metadata !{i32 589865, metadata !"memcpy.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !46} ; [ DW_TAG_file_type ]
!46 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_co
...
!54 = metadata !{i32 589865, metadata !"memmove.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !55} ; [ DW_TAG_file_type ]
!55 = metadata !{i32 589841, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_c
...
!63 = metadata !{i32 589865, metadata !"mempcpy.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !64} ; [ DW_TAG_file_type ]
!64 = metadata !{i32 589841, i32 0, i32 1, metadata !"mempcpy.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_c
...
!72 = metadata !{i32 589865, metadata !"memset.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !73} ; [ DW_TAG_file_type ]
!73 = metadata !{i32 589841, i32 0, i32 1, metadata !"memset.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_co
...
!138 = metadata !{i32 30, i32 0, metadata !137, null}
!139 = metadata !{i32 13, i32 0, metadata !140, null}
!140 = metadata !{i32 589835, metadata !14, i32 12, i32 0, metadata !15, i32 0} ; [ DW_TAG_lexical_block ]
!141 = metadata !{i32 14, i32 0, metadata !140, null}
!142 = metadata !{i32 15, i32 0, metadata !140, null}
!143 = metadata !{i32 15, i32 0, metadata !84, null}
!144 = metadata !{i32 16, i32 0, metadata !84, null}
!145 = metadata !{i32 21, i32 0, metadata !146, null}
!146 = metadata !{i32 589835, metadata !29, i32 20, i32 0, metadata !30, i32 0} ; [ DW_TAG_lexical_block ]
!147 = metadata !{i32 27, i32 0, metadata !146, null}
!148 = metadata !{i32 29, i32 0, metadata !146, null}
!149 = metadata !{i32 16, i32 0, metadata !91, null}
!150 = metadata !{i32 17, i32 0, metadata !91, null}
!151 = metadata !{i32 19, i32 0, metadata !91, null}
!152 = metadata !{i32 22, i32 0, metadata !91, null}
!153 = metadata !{i32 25, i32 0, metadata !91, null}
!154 = metadata !{i32 26, i32 0, metadata !91, null}
!155 = metadata !{i32 28, i32 0, metadata !91, null}
!156 = metadata !{i32 29, i32 0, metadata !91, null}
!157 = metadata !{i32 32, i32 0, metadata !91, null}
!158 = metadata !{i32 20, i32 0, metadata !91, null}
!159 = metadata !{i32 15, i32 0, metadata !116, null}
!160 = metadata !{i32 16, i32 0, metadata !116, null}
!161 = metadata !{i32 17, i32 0, metadata !116, null}
