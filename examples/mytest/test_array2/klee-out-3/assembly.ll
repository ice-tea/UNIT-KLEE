...
@.str = private unnamed_addr constant [5 x i8] c"a[0]\00", align 1
@.str1 = private unnamed_addr constant [5 x i8] c"a[1]\00", align 1
@.str2 = private unnamed_addr constant [5 x i8] c"a[2]\00", align 1
...
entry:
  ...
  %a = alloca [3 x i32]
  %"alloca point" = bitcast i32 0 to i32
  %1 = getelementptr inbounds [3 x i32]* %a, i64 0, i64 0, !dbg !134
  %2 = bitcast i32* %1 to i8*, !dbg !134
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !134
  %3 = getelementptr inbounds [3 x i32]* %a, i64 0, i64 1, !dbg !136
  %4 = bitcast i32* %3 to i8*, !dbg !136
  call void @klee_make_symbolic(i8* %4, i64 4, i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !136
  %5 = getelementptr inbounds [3 x i32]* %a, i64 0, i64 2, !dbg !137
  %6 = bitcast i32* %5 to i8*, !dbg !137
  call void @klee_make_symbolic(i8* %6, i64 4, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !137
