...
@.str2 = private unnamed_addr constant [3 x i8] c"a2\00", align 1
...
entry:
  ...
  %a = alloca [3 x i32]
  %"alloca point" = bitcast i32 0 to i32
  %1 = call i32 @klee_int(i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !134
  %2 = getelementptr inbounds [3 x i32]* %a, i64 0, i64 0, !dbg !134
  store i32 %1, i32* %2, align 4, !dbg !134
  %3 = call i32 @klee_int(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !136
  %4 = getelementptr inbounds [3 x i32]* %a, i64 0, i64 1, !dbg !136
  store i32 %3, i32* %4, align 4, !dbg !136
  %5 = call i32 @klee_int(i8* getelementptr inbounds ([3 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !137
  %6 = getelementptr inbounds [3 x i32]* %a, i64 0, i64 2, !dbg !137
  store i32 %5, i32* %6, align 4, !dbg !137
  %a1 = bitcast [3 x i32]* %a to i32*, !dbg !138
  %7 = call i32 @get_sign(i32* %a1) nounwind, !dbg !138
  store i32 %7, i32* %0, align 4, !dbg !138
  %8 = load i32* %0, align 4, !dbg !138
  store i32 %8, i32* %retval, align 4, !dbg !138
...
!1 = metadata !{i32 589865, metadata !"two_input.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_array2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"two_input.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_array2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} 
...
!136 = metadata !{i32 29, i32 0, metadata !135, null}
!137 = metadata !{i32 30, i32 0, metadata !135, null}
!138 = metadata !{i32 31, i32 0, metadata !135, null}
