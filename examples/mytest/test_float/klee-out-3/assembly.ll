...
define i32 @get_sign(float %a, float %b) nounwind {
entry:
  ...
  %1 = load float* %a_addr, align 4, !dbg !126
  %2 = load float* %b_addr, align 4, !dbg !126
  %3 = fcmp ogt float %1, %2, !dbg !126
...
bb1:                                              ; preds = %entry
  %4 = load float* %a_addr, align 4, !dbg !129
  %5 = load float* %b_addr, align 4, !dbg !129
  %6 = fcmp oeq float %4, %5, !dbg !129
...
entry:
  ...
  %b = alloca float
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast float* %a to i8*, !dbg !132
  call void @klee_make_symbolic(i8* %a1, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !132
  %b2 = bitcast float* %b to i8*, !dbg !134
  call void @klee_make_symbolic(i8* %b2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !134
  %1 = load float* %b, align 4, !dbg !135
  %2 = load float* %a, align 4, !dbg !135
  %3 = call i32 @get_sign(float %2, float %1) nounwind, !dbg !135
  store i32 %3, i32* %0, align 4, !dbg !135
  %4 = load i32* %0, align 4, !dbg !135
  store i32 %4, i32* %retval, align 4, !dbg !135
  %retval3 = load i32* %retval, !dbg !135
  ret i32 %retval3, !dbg !135
}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"get_sign", metadata !"get_sign", metadata !"get_sign", metadata !1, i32 7, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (float, float)* @get_sign} ; [ DW_TAG_subprog
!1 = metadata !{i32 589865, metadata !"two_input.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_float/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"two_input.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_float/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
!3 = metadata !{i32 589845, metadata !1, metadata !"", metadata !1, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !4, i32 0, null} ; [ DW_TAG_subroutine_type ]
!4 = metadata !{metadata !5, metadata !6, metadata !6}
!5 = metadata !{i32 589860, metadata !1, metadata !"int", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!6 = metadata !{i32 589860, metadata !1, metadata !"float", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, i32 4} ; [ DW_TAG_base_type ]
...
!129 = metadata !{i32 13, i32 0, metadata !127, null}
!130 = metadata !{i32 14, i32 0, metadata !127, null}
!131 = metadata !{i32 16, i32 0, metadata !127, null}
!132 = metadata !{i32 22, i32 0, metadata !133, null}
!133 = metadata !{i32 589835, metadata !7, i32 20, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!134 = metadata !{i32 23, i32 0, metadata !133, null}
!135 = metadata !{i32 24, i32 0, metadata !133, null}
