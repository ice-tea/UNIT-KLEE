...
entry:
  ...
  %p1 = bitcast i32** %p to i8*, !dbg !134
  call void @klee_make_symbolic(i8* %p1, i64 8, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !134
  %1 = load i32** %p, align 8, !dbg !135
