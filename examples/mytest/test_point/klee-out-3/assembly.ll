...
entry:
  ...
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !134
  %3 = load i32** %p, align 8, !dbg !135
  %4 = call i32 @get_sign(i32* %3) nounwind, !dbg !135
  store i32 %4, i32* %0, align 4, !dbg !135
  %5 = load i32* %0, align 4, !dbg !135
  store i32 %5, i32* %retval, align 4, !dbg !135
...
!134 = metadata !{i32 21, i32 0, metadata !133, null}
!135 = metadata !{i32 22, i32 0, metadata !133, null}
