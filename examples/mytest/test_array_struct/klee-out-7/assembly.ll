...
define i32 @get_sign(%struct.s* %arr) nounwind {
entry:
  %arr_addr = alloca %struct.s*, align 8
  %retval = alloca i32
  %0 = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  store %struct.s* %arr, %struct.s** %arr_addr
  %1 = load %struct.s** %arr_addr, align 8, !dbg !131
  %2 = getelementptr inbounds %struct.s* %1, i64 0, !dbg !131
  %3 = getelementptr inbounds %struct.s* %2, i32 0, i32 0, !dbg !131
  %4 = load i32* %3, align 4, !dbg !131
  %5 = load %struct.s** %arr_addr, align 8, !dbg !131
  %6 = getelementptr inbounds %struct.s* %5, i64 1, !dbg !131
  %7 = getelementptr inbounds %struct.s* %6, i32 0, i32 0, !dbg !131
  %8 = load i32* %7, align 4, !dbg !131
  %9 = icmp sgt i32 %4, %8, !dbg !131
  %10 = load %struct.s** %arr_addr, align 8, !dbg !133
  br i1 %9, label %bb, label %bb3, !dbg !131

bb:                                               ; preds = %entry
  %11 = getelementptr inbounds %struct.s* %10, i64 0, !dbg !133
  %12 = getelementptr inbounds %struct.s* %11, i32 0, i32 0, !dbg !133
  %13 = load i32* %12, align 4, !dbg !133
  %14 = load %struct.s** %arr_addr, align 8, !dbg !133
  %15 = getelementptr inbounds %struct.s* %14, i64 2, !dbg !133
  %16 = getelementptr inbounds %struct.s* %15, i32 0, i32 0, !dbg !133
  %17 = load i32* %16, align 4, !dbg !133
  %18 = icmp sgt i32 %13, %17, !dbg !133
  br i1 %18, label %bb1, label %bb2, !dbg !133

bb1:                                              ; preds = %bb
  store i32 0, i32* %0, align 4, !dbg !134
  br label %bb6, !dbg !134

bb2:                                              ; preds = %bb
  store i32 2, i32* %0, align 4, !dbg !135
  br label %bb6, !dbg !135

bb3:                                              ; preds = %entry
  %19 = getelementptr inbounds %struct.s* %10, i64 1, !dbg !136
  %20 = getelementptr inbounds %struct.s* %19, i32 0, i32 0, !dbg !136
  %21 = load i32* %20, align 4, !dbg !136
  %22 = load %struct.s** %arr_addr, align 8, !dbg !136
  %23 = getelementptr inbounds %struct.s* %22, i64 2, !dbg !136
  %24 = getelementptr inbounds %struct.s* %23, i32 0, i32 0, !dbg !136
  %25 = load i32* %24, align 4, !dbg !136
  %26 = icmp sgt i32 %21, %25, !dbg !136
  br i1 %26, label %bb4, label %bb5, !dbg !136

bb4:                                              ; preds = %bb3
  store i32 1, i32* %0, align 4, !dbg !137
  br label %bb6, !dbg !137
...
bb6:                                              ; preds = %bb5, %bb4, %bb2, %bb1
  %27 = load i32* %0, align 4, !dbg !134
  store i32 %27, i32* %retval, align 4, !dbg !134
  %retval7 = load i32* %retval, !dbg !134
  ret i32 %retval7, !dbg !134
}
...
entry:
  %retval = alloca i32
  %0 = alloca i32
  %a = alloca [3 x %struct.s]
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast [3 x %struct.s]* %a to i8*, !dbg !139
  call void @klee_make_symbolic(i8* %a1, i64 24, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !139
  %a2 = bitcast [3 x %struct.s]* %a to %struct.s*, !dbg !141
  %1 = call i32 @get_sign(%struct.s* %a2) nounwind, !dbg !141
  store i32 %1, i32* %0, align 4, !dbg !141
  %2 = load i32* %0, align 4, !dbg !141
  store i32 %2, i32* %retval, align 4, !dbg !141
  %retval3 = load i32* %retval, !dbg !141
  ret i32 %retval3, !dbg !141
}
...
entry:
  ...
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* %name) nounwind, !dbg !146
...
bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !153
  unreachable, !dbg !153
...
bb3:                                              ; preds = %bb1
  ...
  call void @klee_make_symbolic(i8* %x4, i64 4, i8* %name) nounwind, !dbg !155
...
bb:                                               ; preds = %bb, %entry
  ...
  br i1 %exitcond1, label %bb1.bb2_crit_edge, label %bb, !dbg !162
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"get_sign", metadata !"get_sign", metadata !"get_sign", metadata !1, i32 11, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (%struct.s*)* @get_sign} ; [ DW_TAG_subprogr
!1 = metadata !{i32 589865, metadata !"two_input.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_array_struct/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"two_input.c", metadata !"/home/bo/workspace/MyKlee/klee-copy/examples/mytest/test_array_struct/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i
...
!7 = metadata !{i32 589846, metadata !1, metadata !"s", metadata !1, i32 9, i64 0, i64 0, i64 0, i32 0, metadata !8} ; [ DW_TAG_typedef ]
!8 = metadata !{i32 589843, metadata !1, metadata !"a", metadata !1, i32 6, i64 64, i64 32, i64 0, i32 0, null, metadata !9, i32 0, null} ; [ DW_TAG_structure_type ]
!9 = metadata !{metadata !10, metadata !11}
!10 = metadata !{i32 589837, metadata !8, metadata !"a", metadata !1, i32 7, i64 32, i64 32, i64 0, i32 0, metadata !5} ; [ DW_TAG_member ]
!11 = metadata !{i32 589837, metadata !8, metadata !"b", metadata !1, i32 8, i64 32, i64 32, i64 32, i32 0, metadata !5} ; [ DW_TAG_member ]
!12 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 27, metadata !13, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!135 = metadata !{i32 16, i32 0, metadata !132, null}
!136 = metadata !{i32 20, i32 0, metadata !132, null}
!137 = metadata !{i32 21, i32 0, metadata !132, null}
!138 = metadata !{i32 23, i32 0, metadata !132, null}
!139 = metadata !{i32 29, i32 0, metadata !140, null}
!140 = metadata !{i32 589835, metadata !12, i32 27, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!141 = metadata !{i32 30, i32 0, metadata !140, null}
!142 = metadata !{i32 13, i32 0, metadata !143, null}
!143 = metadata !{i32 589835, metadata !15, i32 12, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ]
!144 = metadata !{i32 14, i32 0, metadata !143, null}
!145 = metadata !{i32 15, i32 0, metadata !143, null}
!146 = metadata !{i32 15, i32 0, metadata !85, null}
!147 = metadata !{i32 16, i32 0, metadata !85, null}
!148 = metadata !{i32 21, i32 0, metadata !149, null}
!149 = metadata !{i32 589835, metadata !30, i32 20, i32 0, metadata !31, i32 0} ; [ DW_TAG_lexical_block ]
!150 = metadata !{i32 27, i32 0, metadata !149, null}
!151 = metadata !{i32 29, i32 0, metadata !149, null}
!152 = metadata !{i32 16, i32 0, metadata !92, null}
!153 = metadata !{i32 17, i32 0, metadata !92, null}
!154 = metadata !{i32 19, i32 0, metadata !92, null}
!155 = metadata !{i32 22, i32 0, metadata !92, null}
!156 = metadata !{i32 25, i32 0, metadata !92, null}
!157 = metadata !{i32 26, i32 0, metadata !92, null}
!158 = metadata !{i32 28, i32 0, metadata !92, null}
!159 = metadata !{i32 29, i32 0, metadata !92, null}
!160 = metadata !{i32 32, i32 0, metadata !92, null}
!161 = metadata !{i32 20, i32 0, metadata !92, null}
!162 = metadata !{i32 15, i32 0, metadata !117, null}
!163 = metadata !{i32 16, i32 0, metadata !117, null}
!164 = metadata !{i32 17, i32 0, metadata !117, null}
