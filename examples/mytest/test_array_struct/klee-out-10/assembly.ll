...
entry:
  ...
  %12 = getelementptr inbounds %struct.s* %11, i32 0, i32 1, !dbg !133
  %13 = load i32* %12, align 4, !dbg !133
  %14 = load %struct.s** %arr_addr, align 8, !dbg !133
  %15 = getelementptr inbounds %struct.s* %14, i64 1, !dbg !133
  %16 = getelementptr inbounds %struct.s* %15, i32 0, i32 1, !dbg !133
...
bb3:                                              ; preds = %entry
  br i1 %18, label %bb4, label %bb5, !dbg !136
...
bb6:                                              ; preds = %bb5, %bb4, %bb2, %bb1
  %19 = load i32* %0, align 4, !dbg !134
  store i32 %19, i32* %retval, align 4, !dbg !134
...
entry:
  %retval = alloca i32
  %0 = alloca i32
  %a = alloca [2 x %struct.s]
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast [2 x %struct.s]* %a to i8*, !dbg !139
  call void @klee_make_symbolic(i8* %a1, i64 16, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !139
  %a2 = bitcast [2 x %struct.s]* %a to %struct.s*, !dbg !141
