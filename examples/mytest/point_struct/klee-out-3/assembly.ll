...
entry:
  ...
  %4 = icmp sgt i32 %3, 0, !dbg !130
  br i1 %4, label %bb, label %bb1, !dbg !130
...
bb1:                                              ; preds = %entry
  %5 = load %struct.node** %n_addr, align 8, !dbg !133
  %6 = getelementptr inbounds %struct.node* %5, i32 0, i32 0, !dbg !133
  %7 = load i32* %6, align 8, !dbg !133
  %8 = icmp slt i32 %7, 0, !dbg !133
  br i1 %8, label %bb2, label %bb3, !dbg !133
...
bb4:                                              ; preds = %bb3, %bb2, %bb
  %9 = load i32* %0, align 4, !dbg !132
  store i32 %9, i32* %retval, align 4, !dbg !132
...
entry:
  ...
  %node21 = bitcast %struct.node* %node2 to i8*, !dbg !138
  call void @klee_make_symbolic(i8* %node21, i64 16, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !138
  %2 = call i32 @get_sign(%struct.node* %node2) nounwind, !dbg !139
...
!138 = metadata !{i32 28, i32 0, metadata !137, null}
!139 = metadata !{i32 29, i32 0, metadata !137, null}
!140 = metadata !{i32 13, i32 0, metadata !141, null}
!141 = metadata !{i32 589835, metadata !14, i32 12, i32 0, metadata !15, i32 0} ; [ DW_TAG_lexical_block ]
!142 = metadata !{i32 14, i32 0, metadata !141, null}
!143 = metadata !{i32 15, i32 0, metadata !141, null}
!144 = metadata !{i32 15, i32 0, metadata !84, null}
!145 = metadata !{i32 16, i32 0, metadata !84, null}
!146 = metadata !{i32 21, i32 0, metadata !147, null}
!147 = metadata !{i32 589835, metadata !29, i32 20, i32 0, metadata !30, i32 0} ; [ DW_TAG_lexical_block ]
!148 = metadata !{i32 27, i32 0, metadata !147, null}
!149 = metadata !{i32 29, i32 0, metadata !147, null}
!150 = metadata !{i32 16, i32 0, metadata !91, null}
!151 = metadata !{i32 17, i32 0, metadata !91, null}
!152 = metadata !{i32 19, i32 0, metadata !91, null}
!153 = metadata !{i32 22, i32 0, metadata !91, null}
!154 = metadata !{i32 25, i32 0, metadata !91, null}
!155 = metadata !{i32 26, i32 0, metadata !91, null}
!156 = metadata !{i32 28, i32 0, metadata !91, null}
!157 = metadata !{i32 29, i32 0, metadata !91, null}
!158 = metadata !{i32 32, i32 0, metadata !91, null}
!159 = metadata !{i32 20, i32 0, metadata !91, null}
!160 = metadata !{i32 15, i32 0, metadata !116, null}
!161 = metadata !{i32 16, i32 0, metadata !116, null}
!162 = metadata !{i32 17, i32 0, metadata !116, null}
