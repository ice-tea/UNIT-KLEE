...
entry:
  ...
  %node21 = bitcast %struct.node* %node2 to i8*, !dbg !139
  call void @klee_make_symbolic(i8* %node21, i64 16, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !139
  %3 = call i32 @get_sign(%struct.node* %node2) nounwind, !dbg !140
