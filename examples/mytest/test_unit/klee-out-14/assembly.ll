...
entry:
  ...
  store i32 4, i32* %i, align 4, !dbg !126
...
entry:
  %v = alloca [4 x i32]
  %"alloca point" = bitcast i32 0 to i32
  %0 = call i32 (...)* @klee_make_symbolic([4 x i32]* %v, i64 16, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !134
  %v1 = bitcast [4 x i32]* %v to i32*, !dbg !136
