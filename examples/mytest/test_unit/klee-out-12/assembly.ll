...
entry:
  ...
  store i32 3, i32* %i, align 4, !dbg !126
...
entry:
  %v = alloca [3 x i32]
  %"alloca point" = bitcast i32 0 to i32
  %0 = call i32 (...)* @klee_make_symbolic([3 x i32]* %v, i64 12, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !134
  %v1 = bitcast [3 x i32]* %v to i32*, !dbg !136
...
!7 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 20, metadata !8, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ()* @main} ; [ DW_TAG_subprogram ]
